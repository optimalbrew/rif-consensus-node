...
public class UniTrieNodeDecoder {
     ...
     * @return  nodes visited by the BFS traversal, in order
     */
    public static Stream<UniNode> breadthFirstDecoder(final DataLoader loader, final Bytes32 rootHash) {
        ...
        public UniNode next() {
            ...
            while (!children.isEmpty()) {
                ...
                if (child.isReferencedByHash()) {
                    ...
                    final Optional<UniNode> maybeChildNode = nodeFactory.retrieve(child.getHash());
