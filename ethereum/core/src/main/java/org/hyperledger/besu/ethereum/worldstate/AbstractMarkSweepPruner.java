...
public abstract class AbstractMarkSweepPruner implements MarkSweepPruner {
  ...
  Counter getMarkOperationCounter() {
    return markOperationCounter;
  }
