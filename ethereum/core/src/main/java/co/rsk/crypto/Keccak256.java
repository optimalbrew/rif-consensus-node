...
public class Keccak256 implements Serializable, Comparable<Keccak256> {
    ...
    public Keccak256(byte[] rawHashBytes) {
        ...
        this.bytes = Bytes32.wrap(rawHashBytes);
        //this.bytes = rawHashBytes;
    }

    public Keccak256(Bytes32 rawHashBytes) {
        this.bytes = rawHashBytes;
    }
    ...
    public int hashCode() {
        ...
        return Ints.fromBytes(bytes.get(28), bytes.get(29), bytes.get(30), bytes.get(31));
    }
    ...
    public Keccak256 copy() {
        return new Keccak256(bytes.copy());
    }
    ...
    public int compareTo(Keccak256 o) {
        for (int i = 32 - 1; i >= 0; i--) {
            ...
            final int otherByte = o.bytes.get(i) & 0xff;
