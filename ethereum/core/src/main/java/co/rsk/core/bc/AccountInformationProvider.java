...
public interface AccountInformationProvider {
     ...
     */
    @Nullable
    Bytes32 getStorageValue(Address addr, Bytes32 key);
     ...
     */
    @Nullable
    byte[] getStorageBytes(Address addr, Bytes32 key);
     ...
     */
    Iterator<Bytes32> getStorageKeys(Address addr);
     ...
     */
    @Nullable
    BytesValue getCode(Address addr);
