...
import static org.hyperledger.besu.ethereum.vm.aion.util.bytes.ByteUtil.EMPTY_BYTE_ARRAY;
...
public class HashUtil {
    ...
    protected static H256Type type = H256Type.BLAKE2B_256;
    ...
    /**
     * TODO this needs a native library?
    ...
    public static byte[] blake256Native(byte[] in) {
        return null;//Blake2bNative.blake256(in);
    }

    public static byte[] blake256Native(byte[] in1, byte[] in2) {
        return null;//Blake2bNative.blake256(in1, in2);
    }

    public static byte[][] getSolutionHash(
            byte[] personalization, byte[] nonce, int[] indices, byte[] header) {
        return null;//Blake2bNative.getSolutionHash(personalization, nonce, indices, header);
    }
