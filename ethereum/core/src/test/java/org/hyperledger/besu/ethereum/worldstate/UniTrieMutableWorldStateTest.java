...
public class UniTrieMutableWorldStateTest {
  ...
  public void commitAndPersist() {
    ...
    final Hash expectedRootHash =
        Hash.fromHexString("0x653f6f6dd8f9d0ab7184ad2d40090e0fd6be81ee36424140281153126a16c85d");
  ...
  public void getAccountNonce_AccountExists() {
    ...
    assertThat(worldState.rootHash())
        .isEqualTo(
            Hash.fromHexString(
                "0xd907100df9ac624c84b6948e012d8776ffbe6e4eb23d4b06029fa03fb48e9832"));
  }
  ...
  public void getAccountBalance_AccountExists() {
    ...
    assertThat(worldState.rootHash())
        .isEqualTo(
            Hash.fromHexString(
                "0x653f6f6dd8f9d0ab7184ad2d40090e0fd6be81ee36424140281153126a16c85d"));
  }
  ...
  public void replaceAccountBalance() {
    ...
    assertThat(worldState.rootHash())
        .isEqualTo(
            Hash.fromHexString(
                "0xa99f6131a941e21752c43ff51ddb04625c5df3c30260dd244bba9df6186e8412"));
  }
  ...
  public void setStorageValue_NonzeroValue() {
    ...
    assertThat(worldState.rootHash())
        .isEqualTo(
            Hash.fromHexString(
                "0xf12968fcb8c55f09c100a5683bd82db593f4072dd1009ac56c0b7ff88e5046a7"));
  ...
  public void replaceStorageValue_NonzeroValue() {
    ...
    assertThat(worldState.rootHash())
        .isEqualTo(
            Hash.fromHexString(
                "0xc43348811fa4d35c98ee17762d95523c7b68f2e8a4b5d509d45988892af10b06"));
    verifyStoragePrefixRootIsPresent(worldState, ADDRESS);
  }
  ...
  private void verifyStoragePrefixRootIsPresent(
    ...
    BytesValue storagePrefix = keyMapper.getAccountStoragePrefixKey(address);
    assertThat(worldState.getUniTrie().get(storagePrefix)).contains(BytesValue.of(0));
  }
