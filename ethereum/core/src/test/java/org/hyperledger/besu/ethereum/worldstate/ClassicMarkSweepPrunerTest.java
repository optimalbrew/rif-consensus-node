...
public class ClassicMarkSweepPrunerTest {
  ...
  public void mark_marksAllExpectedNodes() {
    final ClassicMarkSweepPruner pruner =
        new ClassicMarkSweepPruner(worldStateStorage, blockchain, markStorage, metricsSystem);
  ...
  public void sweepBefore_shouldSweepStateRootFirst() {
    final ClassicMarkSweepPruner pruner =
        new ClassicMarkSweepPruner(worldStateStorage, blockchain, markStorage, metricsSystem, 1);
