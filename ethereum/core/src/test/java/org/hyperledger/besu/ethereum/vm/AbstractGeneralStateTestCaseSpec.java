...
public abstract class AbstractGeneralStateTestCaseSpec {

  private final Map<String, List<GeneralStateTestCaseEipSpec>> finalStateSpecs;

  public AbstractGeneralStateTestCaseSpec(
      final BlockHeaderMock blockHeader,
      final MutableWorldState initialWorldState,
      final Map<String, List<PostSection>> postSection,
      ...
      for (final PostSection p : post) {
        ...
        specs.add(
            new GeneralStateTestCaseEipSpec(
                ...
                txSupplier,
                initialWorldState,
                runtimeWorldState(initialWorldState),
                p.rootHash,
                p.logsHash,
                blockHeader,
                shouldCheckRootHash()));
  ...
  abstract MutableWorldState runtimeWorldState(WorldState initialWorldState);

  abstract boolean shouldCheckRootHash();
  ...
  public static class Indexes {
    ...
    public boolean equals(final Object obj) {
      ...
      final GeneralStateTestCaseSpec.Indexes other = (GeneralStateTestCaseSpec.Indexes) obj;
