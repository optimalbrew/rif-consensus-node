...
public abstract class AbstractVMReferenceTestBase extends AbstractRetryingTest {
  ...
  abstract MutableWorldState runtimeWorldState(final WorldState initialWorldState);

  @Override
  protected void runTest() {
    final MutableWorldState worldState = runtimeWorldState(spec.getInitialWorldState());
