...
public class ECIESHandshakeTest {
  ...
  private static class Expectations {
    private static final byte[] aesSecret =
        h32("0xc0458fa97a5230830e05f4f20b7c755c1d4e54b1ce5cf43260bb191eef4e418d").extractArray();
    private static final byte[] macSecret =
        h32("0x48c938884d5067a1598272fcddaa4b833cd5e7d92e8228c0ecdfabbe68aef7f1").extractArray();
    private static final byte[] token =
        h32("0x3f9ec2592d1554852b1f54d228f042ed0a9310ea86d038dc2b401ba8cd7fdac4").extractArray();
    private static final byte[] initialEgressMac =
        h32("0x09771e93b1a6109e97074cbe2d2b0cf3d3878efafe68f53c41bb60c0ec49097e").extractArray();
    private static final byte[] initialIngressMac =
        h32("0x75823d96e23136c89666ee025fb21a432be906512b3dd4a3049e898adb433847").extractArray();
  }
  ...
  public void ingressEgressMacsAsExpected() {
    ...
    initiator.setInitiatorMsgEnc(BytesValue.wrap(Messages.initiatorMsgEnc));
    initiator.setEphKeyPair(Input.initiatorEphKeyPair);
    initiator.setInitiatorNonce(Input.initiatorNonce);
    ...
    // secrets.
    responder.setResponderMsgEnc(BytesValue.wrap(Messages.responderMsgEnc));
